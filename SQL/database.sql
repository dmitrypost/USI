...
CREATE TABLE tblRole (rol_usr_id INT NOT NULL AUTO_INCREMENT, rol_pjt_id INT, rol_name TINYTEXT, rol_rst_id INT, rol_description MEDIUMTEXT, CONSTRAINT rol_id PRIMARY KEY (rol_usr_id,rol_pjt_id));
...
CREATE TABLE tblPage(pge_id INT NOT NULL AUTO_INCREMENT, pge_name TINYTEXT NOT NULL, pge_body MEDIUMTEXT, PRIMARY KEY (pge_id));
...
ALTER TABLE tblRole ADD FOREIGN KEY (rol_rst_id) REFERENCES tblRoleState(rst_id);
