...
CREATE TABLE tblProject (pjt_id INT NOT NULL AUTO_INCREMENT, pjt_name TINYTEXT, pjt_body LONGTEXT, pjt_description TINYTEXT, pjt_key_id INT, pjt_picture MEDIUMTEXT, pjt_mgr_id INT, pjt_pageview INT, pjt_year YEAR, PRIMARY KEY (pjt_id));
