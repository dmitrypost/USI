<?php
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		$con = open();
		if (isset($_POST['txt_title']) AND isset($_POST['firstname']) AND isset($_POST['lastname']) AND isset($_POST['email']) AND isset($_POST['gradstatus']) AND isset($_POST['major']) AND isset($_POST['phone']) AND isset($_POST['linkedin'])) 
		{ 
			//get the values out of the submitted data safely
			$txt_title = mysqli_real_escape_string($con,trim(strip_tags($_POST['txt_title']))); 
